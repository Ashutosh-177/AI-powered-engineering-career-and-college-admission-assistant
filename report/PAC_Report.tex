...
\item \textbf{Assistant} -- the guided, chained flow through all 8 stages, each stage showing its mode badge, structured output, prompt-view, refine box, and Continue button (Fig.~\ref{fig:assistant}).
