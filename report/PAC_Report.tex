...
\pagestyle{fancy}
\fancyhf{}
\fancyhead[L]{\small PAC -- PEGAI}
\fancyhead[C]{\small Ashutosh Kumar Singh \textbullet\ 92301733016}
...
\title{\textbf{Practical Assessment Component (PAC) Report}\\[2pt]\Large Prompt Engineering for Generative AI (PEGAI)\\[8pt]
\large PathFinder: A Generative AI-Powered Career and College\\ Admission Assistant for Engineering Aspirants}
\author{\normalsize\textbf{Ashutosh Kumar Singh}\\[2pt]
\normalsize Enrollment No.\ 92301733016\\[2pt]
\normalsize Subject: PEGAI --- Prompt Engineering for Generative AI}
\date{}
...
\begin{tabular}{@{}l@{\hspace{1.2em}}p{11.2cm}@{}}
\textbf{Name} & Ashutosh Kumar Singh \\
\textbf{Enrollment No.} & 92301733016 \\
\textbf{Subject} & PEGAI --- Prompt Engineering for Generative AI \\
\textbf{Component} & Practical Assessment Component (PAC) \\
\textbf{Project} & PathFinder --- GenAI Career \& College Admission Assistant \\[4pt]
\textbf{Live demo} & \url{https://ashutosh-177.github.io/AI-powered-engineering-career-and-college-admission-assistant/} \\[3pt]
\textbf{Source code} & \url{https://github.com/Ashutosh-177/AI-powered-engineering-career-and-college-admission-assistant} \\
\end{tabular}

\vspace{4pt}
\noindent\small The live demo runs in offline mode by default, so it is fully explorable with no API key. Entering an Anthropic API key in the Settings tab switches the same prompts to live Claude responses.\normalsize
...
\url{https://ashutosh-177.github.io/AI-powered-engineering-career-and-college-admission-assistant/}\\
with full source (app, report source, prompt-output samples) at\\
\url{https://github.com/Ashutosh-177/AI-powered-engineering-career-and-college-admission-assistant}

\noindent Because the app is a client-only static bundle with no backend, deployment is simply the repository itself --- which also means there is no server-side store of student data to breach (\S\ref{sec:privacy}), and no shared API key: the live site runs in offline mode for every visitor until they supply their own key locally.
